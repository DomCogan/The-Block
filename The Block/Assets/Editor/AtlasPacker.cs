...
public class AtlasPacker : EditorWindow
{
    ...
    int blockSize = 32; // Block size in pixels.
    ...
    [MenuItem("The Block/Atlas Packer")] // Create a menu item to show the window.
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label("The Block Texture Atlas Packer", EditorStyles.boldLabel);
